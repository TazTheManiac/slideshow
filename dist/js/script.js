...
document.querySelectorAll('.slideshow').forEach(function (slideshow) {
  ...
  var i = 0;
  slideshow.querySelectorAll('.indicators button').forEach(function (button) {
...
function prevSlide(slideshow) {
  var activeSlide = slideshow.querySelector('.slides-wrapper .active');
  var activeIndicator = slideshow.querySelector('.indicators .active');
...
function gotoSlide(slideshow, button) {
  var gotoNr = button.dataset.slideTo;
